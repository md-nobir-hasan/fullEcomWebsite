                                ...
                                <div class="bg-soft-primary">
                                    <div class="row">
                                        ...
                                        <div class="col-5 align-self-end">
                                            <img src="{{ asset('backend/assets/images/profile-img.png') }}"
                                                alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-centered table-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <div>
                                                    <img src="{{ asset('backend/assets/images/product/img-7.png') }}"
                                                        alt="" class="avatar-sm">
                                                </div>
                                            </th>
                                            <td>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div>
                                                    <img src="{{ asset('backend/assets/images/product/img-4.png') }}"
                                                        alt="" class="avatar-sm">
                                                </div>
                                            </th>
                                            <td>
